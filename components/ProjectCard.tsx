    ...
    return (
        <div className="flex flex-col w-fit">
            <div className="rounded-tr-2xl rounded-tl-2xl relative">
                ...
                <div 
                    className="absolute right-[72px] bottom-5 w-7 h-7 cursor-pointer"
                ...
                <div className="absolute right-4 bottom-4 w-9 h-9 cursor-pointer" onClick={toggleMenu}>
                    <Image src="/images/menu.svg" alt="Menu icon" fill className="object-cover hover-zoom" />
                </div>
                {isMenuOpen && (
                    <>
                        ...
                        <div className="absolute right-4 bottom-[-95px] bg-white rounded-lg min-w-[120px] z-10 overflow-hidden shadow-[0px_4px_4px_0px_#00000040]">
                            <button className="cursor-pointer w-full text-left px-5 py-[14px] hover:bg-gray-100 font-normal text-base leading-4 text-accent border-b border-line">
                                <div className="flex items-center gap-3">
                                    <Image src="/images/edit.svg" alt="Edit icon" width={24} height={24} />
                                    <span>Editar</span>
                                </div>
                            </button>
                            <button className="cursor-pointer w-full text-left px-5 py-[14px] hover:bg-gray-100 font-normal text-base leading-4 text-accent">
                                <div className="flex items-center gap-3">
                                    <Image src="/images/trash.svg" alt="Trash icon" width={24} height={24} />
                                    <span>Remover</span>
                                </div>
                            </button>
                        </div>
